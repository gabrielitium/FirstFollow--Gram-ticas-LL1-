 ...
 * jdPrimeros.java
 *
 * Created on 1/07/2010, 07:30:16 PM
 */
 ...
 * @author usuario
 */
public class jdPrimeros extends javax.swing.JDialog {
    ...
    /** Creates new form jdPrimeros */
    public jdPrimeros(java.awt.Frame parent, boolean modal, ConjuntosPrediccion cp) {
        super(parent, modal);
        initComponents();
    ...
    private void jbAyudaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbAyudaMouseClicked
        ...
        ja.setTitle("Algoritmo para Calcular primeros. ");
        ja.lblMensajes.setIcon(new javax.swing.ImageIcon(getClass().getResource("/firstfollow/Images/Primeros.JPG")));
